...
class Addoppourtunity extends StatefulWidget {
  const Addoppourtunity({Key? key}) : super(key: key);

  @override
  State<Addoppourtunity> createState() => _AddoppourtunityState();
}

class _AddoppourtunityState extends State<Addoppourtunity> {
...
print("kkkkkkkkkkkkkkk"+Category.toString());
  ...
  void AddtoActivity() async {
    ...
    final collection = db.collection('Opportunity');
    final document = collection.doc();
    final storage = FirebaseStorage.instance;
    final imageRef = storage.ref('OpportunityImage').child(document.id);
    ...
    ScaffoldMessenger.of(context).showMaterialBanner(MaterialBanner(
      ...
      elevation: 0,
      content: Text('${title.text} was added to your Opportunity!'),
  ...
  Widget build(BuildContext context) => Scaffold(
    appBar: AppBar(
      ...
      title: const Text('Add oppourtunity'),
    ),
    body: ListView(
      children: [
        GestureDetector(
